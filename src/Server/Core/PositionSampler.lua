...
function PositionSampler.Init()
    ...
    if PositionSampler._initPromise then
        print("PositionSampler: Initialization already in progress")
        return PositionSampler._initPromise
    end

    PositionSampler._initPromise = Promise.new(function(resolve, reject)
