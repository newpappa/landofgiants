...
local GiantPurchaseSuccess = script.Parent.GiantBuyModal:WaitForChild("GiantPurchaseSuccess")
local SpeedPurchaseSuccess = script.Parent.SpeedBuyModal:WaitForChild("SpeedPurchaseSuccess")
